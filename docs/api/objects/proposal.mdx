...
#### `alreadyReacted` ([`Boolean`](/api/scalars/boolean))
...
#### `category` ([`Category`](/api/objects/category))
...
#### `categoryId` ([`String`](/api/scalars/string))
...
#### `isOwner` ([`Boolean`](/api/scalars/boolean))
...
#### `registeredReactions` ([`[String!]!`](/api/scalars/string))
...
#### `totalReactions` ([`Int!`](/api/scalars/int))
