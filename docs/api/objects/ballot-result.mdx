...
#### `ballotResultProposals` ([`[BallotResultProposal!]!`](/docs/api/objects/ballot-result-proposal))
...
#### `isRatified` ([`Boolean!`](/docs/api/scalars/boolean))
...
#### `ratifiedBy` ([`Party`](/docs/api/objects/party))
...
#### `statistics` ([`ResultsStatistics!`](/docs/api/objects/results-statistics))

Totals and sums of all reactions and interactions

#### `submittedAt` ([`ISO8601DateTime`](/docs/api/scalars/iso-8601-date-time))
