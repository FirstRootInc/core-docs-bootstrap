...
#### `singleUse` ([`Boolean!`](/docs/api/scalars/boolean))
...
#### `usedAt` ([`ISO8601DateTime`](/docs/api/scalars/iso-8601-date-time))

#### `validFrom` ([`ISO8601DateTime`](/docs/api/scalars/iso-8601-date-time))

The initial value in which this verification token starts to be valid.

#### `validUntil` ([`ISO8601DateTime`](/docs/api/scalars/iso-8601-date-time))

The final date and time in which this token still be valid.

#### `verifiableId` ([`ID!`](/docs/api/scalars/id))

The related entity ID. This is the entity that uses the token to verify a certain action

#### `verifiableType` ([`String!`](/docs/api/scalars/string))
