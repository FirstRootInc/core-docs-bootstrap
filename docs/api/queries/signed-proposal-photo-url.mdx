...
#### `objectId` ([`String`](/docs/api/scalars/string))
...
#### `imageType` ([`ImageEnumTypes!`](/docs/api/enums/image-enum-types))

Image type to upload. In the future this field can change to cover other scenarios.

#### `objectType` ([`ObjectEnumTypes!`](/docs/api/enums/object-enum-types))

Type of object to which the image will assigned.

### Type

#### [`SignedUrlResponse`](/docs/api/objects/signed-url-response)
